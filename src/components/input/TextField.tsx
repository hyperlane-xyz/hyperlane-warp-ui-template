...
const defaultInputClasses =
  'mt-1.5 px-2.5 py-2 text-sm rounded-full border border-primary-300 focus:border-primary-500 disabled:bg-gray-150 outline-none transition-all duration-300';
