...
export function Header() {
  ...
  return (
    <header className="relative flex w-full items-center justify-between bg-primary-25 px-4 py-3 shadow-app-header lg:justify-center lg:bg-transparent lg:px-6 lg:pb-2 lg:pt-3 lg:shadow-none dark:border-b dark:border-primary-300/25 dark:bg-background/[0.88] dark:shadow-app-header-dark lg:dark:border-b-0 lg:dark:bg-transparent lg:dark:shadow-none">
      ...
      <div className="flex items-center gap-3 lg:hidden">
        ...
        <DropdownMenu
          ...
          buttonClassname="rounded p-2 text-primary-500 data-[open]:bg-primary-25 data-[open]:shadow-[inset_4px_4px_4px_rgba(154,13,255,0.1)] data-[open]:text-white dark:bg-surface/30 dark:text-foreground-primary dark:data-[open]:bg-primary-300/25 dark:data-[open]:ring-1 dark:data-[open]:ring-primary-300/45 dark:data-[open]:text-white"
          ...
          menuItems={navLinks.map((item) => (
            <NavItem
              key={item.title}
              item={item}
              className="w-full gap-3 px-6 py-2 hover:bg-primary-50 hover:bg-opacity-30 dark:text-foreground-primary dark:hover:bg-primary-300/15 dark:[&_path]:fill-current dark:[&_path]:stroke-current"
            />
          ))}
        />
      </div>
