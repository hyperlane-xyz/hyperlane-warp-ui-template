...
export function TipCard() {
  ...
  return (
    <Card className="w-100 p-2 sm:w-[31rem]">
      <h2 className="text-primary-500">HYPER is a crosschain asset!</h2>
      <div className="flex items-end justify-between">
        <p className="mt-1 max-w-[75%] text-xs">
          Bridge across Arbitrum, Base, BNB Chain, Ethereum, and Optimism.
        </p>
        <a
          href="https://docs.hyperlane.xyz/docs/protocol-economics/intro"
          target="_blank"
