...
export function TipCard() {
  ...
  return (
    <Card className="w-100 p-2 sm:w-[31rem]">
      <h2 className="text-primary-500">Update for MAGIC bridges!</h2>
      <div className="flex items-end justify-between">
        <p className="mt-1 max-w-[75%] text-xs">
          Please use the official Treasure UI for token transfers between Treasure and Arbitrum
        </p>
        <a
          href="https://bridge.treasure.lol/"
          target="_blank"
        ...
        >
          ...
          <span className="ml-1.5 hidden text-sm sm:inline">Link</span>
        </a>
      </div>
