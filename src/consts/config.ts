...
const registryUrl =
  process?.env?.NEXT_PUBLIC_REGISTRY_URL || 'https://github.com/hyperlane-xyz/hyperlane-registry';
const registryBranch =
  process?.env?.NEXT_PUBLIC_REGISTRY_BRANCH || 'nambrot/stableswap-extension-deploy';
