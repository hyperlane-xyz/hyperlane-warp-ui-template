...
export const config: Config = Object.freeze({
  ...
  explorerApiUrl,
  relayApiUrl,
  defaultTransferOriginToken: 'nesachain-0x0000000000000000000000000000000000000000',
  defaultTransferDestinationToken: 'bsc-0x097acf27503753e77bCA940277806156C5925B81',
  isDevMode,
  registryUrl,
  registryBranch,
  registryProxyUrl,
