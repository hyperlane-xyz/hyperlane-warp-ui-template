export const links = {
  ...
  explorerInj: 'https://injscan.com/',
  explorerInEvm: 'https://inevm.calderaexplorer.xyz',
  explorer: 'https://explorer.hyperlane.xyz',
  docs: 'https://docs.injective.network/developers-evm/network-information',
  about: 'https://injective.com/about',
  support: 'https://discord.gg/injective',
