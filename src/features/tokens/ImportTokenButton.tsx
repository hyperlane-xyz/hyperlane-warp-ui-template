...
export function ImportTokenButton({ token }: ImportTokenButtonProps) {
  ...
  return (
    <button
      type="button"
      className="flex items-center text-sm text-primary-500 hover:text-primary-700 disabled:opacity-50 dark:text-text-secondary dark:hover:text-text-primary [&_path]:fill-primary-500 [&_path]:hover:fill-primary-700 dark:[&_path]:fill-current dark:hover:[&_path]:fill-current"
