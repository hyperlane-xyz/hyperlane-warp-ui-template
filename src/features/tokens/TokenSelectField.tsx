...
const styles = {
  base: 'transfer-token-field w-full py-2 flex items-center justify-between transition-all rounded-md px-1.5 border duration-150 border-gray-400/25 shadow-sm group',
