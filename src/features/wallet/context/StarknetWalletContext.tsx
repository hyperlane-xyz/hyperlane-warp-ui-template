...
export function StarknetWalletContext({ children, enabled = true }: WalletContextProps) {
  if (!enabled) return <>{children}</>;
  return <EnabledStarknetWalletContext>{children}</EnabledStarknetWalletContext>;
}

function EnabledStarknetWalletContext({ children }: PropsWithChildren<unknown>) {
