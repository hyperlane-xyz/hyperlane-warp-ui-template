...
=======
import { metadata as starknetsepolia } from '@hyperlane-xyz/registry/chains/starknetsepolia/metadata.js';
...
=======
  ...
  const chains = useMemo(() => {
    const combinedChains = [...getStarknetChains(multiProvider), initialChain];
>>>>>>> origin/main
